...
class CompetitorView(BaseView):
    ...
    def refresh(self):
        ...
        fig_price.add_hline(y=150, line_dash="dash", line_color="#f85149",
                          annotation_text="Budget Hotel Benchmark (~$150)", annotation_position="top right")
        fig_price.add_hline(y=250, line_dash="dash", line_color="#d29922",
        ...
        fig_room = go.Figure(data=[
            go.Bar(name='Listings', x=room_stats['Room Type'], 
                   y=room_stats['Count'], yaxis='y', marker_color='#58a6ff'),
        ...
        # Consistent room type colors
        room_type_colors = {
            'Entire home/apt': '#58a6ff',
            'Private room': '#3fb950',
            'Shared room': '#d29922'
        }
        ...
        fig_share = px.pie(
            ...
            color_discrete_sequence=['#3fb950', '#58a6ff', '#d29922', '#f85149', '#a371f7']
        )
